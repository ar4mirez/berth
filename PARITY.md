...
| unported subcommands | `berth repo new\|create\|publish <org> …` fail with `… is not in berth yet (phase 3); use ccenv for now`, before any side effect | until 3c; ccenv would first write `repos.txt` |
